...
hi Cursor           ctermfg=11 ctermbg=251 gui=underline guifg=white guibg=green
hi ICursor          ctermfg=247 ctermbg=251 guibg=#babdb6

" Search
hi Search           term=reverse cterm=reverse ctermfg=214 ctermbg=239 gui=reverse guifg=white guibg=blue
hi IncSearch        term=reverse ctermfg=239 ctermbg=214 guifg=white guibg=blue
...
hi Visual                       term=reverse ctermbg=129 guifg=white guibg=blue
...
" Syntax
hi Comment          term=bold ctermfg=45 gui=bold,underline guifg=DarkMagenta
...
hi Function         ctermfg=177 gui=bold,underline,italic guifg=green
hi Type             ctermfg=253             guifg=#e3e7df               gui=none cterm=none
hi Keyword          term=bold,reverse cterm=bold,reverse ctermfg=254 gui=bold,reverse guifg=#eeeeec
